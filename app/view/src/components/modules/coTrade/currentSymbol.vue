...
<template>
  <div class="currentSymbol a-21-bg a-3-bd">
    <div class="operations-btn a-8-bd">
      <div class="symbol-total b-1-cl"
       @click.stop="showMarket">
        <i class="hoverHide" :class="{'b-4-cl' : isShowMarket}">
          {{ activeContractName }}
          <!-- <span class="triangle-down b-2-bd" :class="{'b-4-bd' : isShowMarket}"></span> -->
        </i>
        <i class="hoverShow b-4-cl"> {{ activeContractName }}
      ...
      <div class="info-item activePrice-item">
        ...
        <span class="tit activePrice" :class="activePriceClass">
          ...
          <i class="rose b-1-cl" :class="activeWsData.roseClass">
            {{activeWsData.rose}}%
          </i>
        </span>
      </div>
