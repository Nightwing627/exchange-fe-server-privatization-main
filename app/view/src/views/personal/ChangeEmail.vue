<template>
  <div class="user-management-change-email a-5-bg">
    ...
    <div class="user-management-center a-5-bg">
      <p class="center-title b-7-cl">
        ...
        </svg>{{$t('personal.prompt.warningChangeEmail')}}</p>
...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/ChangeEmail/ChangeEmail';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/ChangeEmail/ChangeEmail.styl';
