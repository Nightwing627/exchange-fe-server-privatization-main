...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/broker/broker/broker';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/broker/broker/broker.styl';
