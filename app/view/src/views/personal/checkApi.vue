...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/checkApi/checkApi';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/personal/checkApi/checkApi.styl';
