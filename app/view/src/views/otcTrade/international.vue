      ...
      <vue-scroll>
        <div class="page-otcTrade-bar">
          ...
          <div class="otcTrade-header a-3-bd">
            ...
            <div class="otcTrade-header-even">
              <div
                class="otcTrade-header-even-value b-1-cl"
              >{{axiosObj.turnover | BTCFixD(that)}} BTC</div>
              <!-- 历史成交(折合BTC) -->
          ...
          <div class="otcTrade-options-trade" v-if="optionsFlag === 'even'">
            ...
            <div
              class="b-7-cl warning"
              v-if="axiosObj.side === 'SELL' && windFlag"
...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/otcTrade/otcTrade';
