...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/mining/mining';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/mining/mining.styl';
