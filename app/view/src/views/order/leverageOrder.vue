...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/order/leverageOrder/leverageOrder';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/order/leverageOrder/leverageOrder.styl';
