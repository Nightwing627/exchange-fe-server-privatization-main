...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/order/exchangeOrder/exchangeOrder';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/order/exchangeOrder/exchangeOrder.styl';
