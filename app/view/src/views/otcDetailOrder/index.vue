<template>
  <section class="page-otcDetailOrder a-5-bg" ref="content">
    <vue-scroll>
        ...
        <c-dialog :showFlag="goPayFlag"
          ...
          <div class="goPayDialog">
            ...
            <ul class="list">
              ...
              <!-- 对方支付方式 -->
              <li class="a-4-bg">
                <div>{{ $t('otcDetailOrder.Otherparty') }}
                  {{ payObj.name }}</div>
                <div class="value b-1-cl"
                  :class="(payObj.payment === 'otc.payment.alipay'
                  || payObj.payment === 'otc.payment.wxpay') ? 'haveEvm' : ''"
                  >
                  <!-- 微信/支付宝 -->
                  <span v-if="payObj.payment === 'otc.payment.alipay'
...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/otcDetailOrder/index/index';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/otcDetailOrder/index/index.styl';
