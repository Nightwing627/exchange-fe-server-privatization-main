...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/resetPass/resetPass';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/resetPass/resetPass.styl';
// 获取验证码
export default {
  mixins: [mixin],
  mounted() {
