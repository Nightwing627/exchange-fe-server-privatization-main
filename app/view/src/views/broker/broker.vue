...
<script>
import mixin from '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/broker/broker/broker';
import '@knoxexchange/blockchain-ui-privatization/PC/common-mixin/broker/broker/broker.styl';
